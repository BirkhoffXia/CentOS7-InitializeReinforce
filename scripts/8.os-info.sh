...
function info_system () {
  log::info "[${COUNT}] 获取系统相关信息-Get information about computer system."
  ...
  echo -e "[Network Info]\n"
  # echo -e "External Network IP: ${G}$(curl -s --connect-timeout 15 --insecure https://ipecho.net/plain)${N}"
  echo -e "External Network IP: ${G}222.222.177.25${N}"
  echo -e "Network Card Device Information:"
  nmcli device show
